...
public class LoginFormBasedAuth extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_login_form_based_auth);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.login_form_based_auth, menu);
		return true;
	}
